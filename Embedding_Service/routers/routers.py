...
from Embedding_Service.models.models import EmbedInput, DenseEmbeddingResponse, SparseEmbeddingResponse
...
class EmbeddingService:
    ...
    @app.post("/dense/query",response_model=DenseEmbeddingResponse)
    ...
    @app.post("/sparse/bm25",response_model=SparseEmbeddingResponse)
    ...
    @app.post("/sparse/splade",response_model=SparseEmbeddingResponse)
    ...
    @app.post("/sparse/tfidf",response_model=SparseEmbeddingResponse)
    ...
    @app.post("/dense/text",response_model=DenseEmbeddingResponse)
